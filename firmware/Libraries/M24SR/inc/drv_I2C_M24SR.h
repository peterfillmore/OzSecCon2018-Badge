...
/* M24SR GPIO mapping -------------------------------------------------------------------------*/
#define M24SR_SDA_PIN 			GPIO_Pin_0
#define M24SR_SDA_PIN_SOURCE 	GPIO_PinSource0
#define M24SR_SDA_PIN_PORT 		GPIOF

#define M24SR_SCL_PIN 			GPIO_Pin_1
#define M24SR_SCL_PIN_SOURCE 	GPIO_PinSource1
#define M24SR_SCL_PIN_PORT 		GPIOF
	
#define M24SR_GPO_PIN 			GPIO_Pin_8
#define M24SR_GPO_PIN_PORT 		GPIOB

#define M24SR_RFDIS_PIN 		GPIO_Pin_9
#define M24SR_RFDIS_PIN_PORT 	GPIOB

#define M24SR_GPIO_BLOCK_CLK	(RCC_AHBPeriph_GPIOF | RCC_AHBPeriph_GPIOB)

/* 	I2C config	------------------------------------------------------------------------------*/
#define M24SR_I2C               I2C1
#define M24SR_I2C_BLOCK_CLK	    RCC_APB1Periph_I2C1
